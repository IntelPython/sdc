...
::
    ...
    > conda create -n sdc_env python=<3.7 or 3.6> pyarrow=0.17.0 pandas=1.1.3 -c anaconda -c conda-forge
...
::
    ...
    > conda create -n sdc_env python=<3.7 or 3.6> pip pyarrow=0.17.0 pandas=1.1.3 -c anaconda -c conda-forge
    > conda activate sdc_env
