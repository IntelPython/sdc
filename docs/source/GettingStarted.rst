...
HPAT compiles and parallelizes the functions annotated with the :func:`@hpat.jit`
...
You can use the following step if master of `Numba <http://numba.pydata.org/numba-doc/latest/index.html>`_ is needed for latest hpat package::
...
such as `Numba <http://numba.pydata.org/numba-doc/latest/index.html>`_ on Ubuntu Linux.
