...
def foo_ovld_list():
    ...
    def foo_list_in_list(a: typing.List[typing.List[int]], b: typing.List[typing.List[typing.List[float]]] = [[[0.0, 0.0]]]):
        return('list_in_list', a, b)

    def foo_tuple_in_tuple(a: typing.Tuple[typing.Tuple[int]], b: typing.Tuple[typing.Tuple[typing.Tuple[float]]] = ((0.0, 0.0))):
    ...
    return foo_int, foo_float, foo_bool, foo_str, foo_list, foo_tuple, foo_dict, foo_union, foo_optional, foo_list_in_list, foo_tuple_in_tuple, foo_typevars_T_T, foo_typevars_list_T, foo_typevars_list_dict, foo_typevars_list_dict_list, foo_typevars_T_K
