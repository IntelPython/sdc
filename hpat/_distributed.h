...
// [0, 2, 0, 1].
static inline std::vector<int64_t> find_dest_ranks(int64_t rank, int64_t num_ranks,
...
static inline  std::vector<int> find_send_counts(const std::vector<int64_t>& dest_ranks,
...
static inline std::vector<int> find_recv_counts(int64_t rank, int64_t num_ranks,
                                                int64_t *p, int64_t p_len,
                                                int64_t elem_size)
{
    auto begin = hpat_dist_get_start(p_len, num_ranks, rank);
...
static inline void apply_permutation(unsigned char *v, int64_t elem_size,
                                     std::vector<size_t>& p)
{
