...
static void __hpat_timsort_reverse_run(int64_t *comp_arr, int64_t start, int64_t end,int64_t ** all_arrs,const size_t all_arrs_len);
static int  __hpat_timsort_getrun(int64_t *comp_arr, const size_t size, __HPAT_TIMSORT_TEMP_BUFFER *store, const uint64_t minrun, __HPAT_TIMSORT_RUN_STACK *run_stack,
				  uint64_t *curr, int64_t ** all_arrs ,const size_t all_arrs_len);
static int __hpat_timsort_checkrules(__HPAT_TIMSORT_RUN_STACK *run_stack);
static int __hpat_timsort_applyrules(int64_t *comp_arr, __HPAT_TIMSORT_RUN_STACK *stack, __HPAT_TIMSORT_TEMP_BUFFER *store, const size_t size, int64_t ** all_arrs, const size_t all_arrs_len);
static int64_t  __hpat_timsort_count_run(int64_t *comp_arr, const uint64_t start, const size_t size, int64_t ** all_arrs,const size_t all_arrs_len);
static void __hpat_timsort_merge_run(int64_t *comp_arr, const __HPAT_TIMSORT_RUN_STACK *run_stack, __HPAT_TIMSORT_TEMP_BUFFER *store, int64_t ** all_arrs,const size_t all_arrs_len);
...
static int __hpat_timsort_applyrules(int64_t *comp_arr, __HPAT_TIMSORT_RUN_STACK *run_stack,
				     __HPAT_TIMSORT_TEMP_BUFFER *store, const size_t size, int64_t ** all_arrs, const size_t all_arrs_len) {
  /*
    RULE 1 = X > Y + Z
    RULE 2 = Y > Z
*/
...
static void __hpat_timsort_mergeleft_run(int64_t *comp_arr, const int64_t run1_len, const int64_t run2_len, int64_t * temp_buffer,
                                         const int64_t stack_ptr, int64_t ** all_arrs, const size_t all_arrs_len, const size_t min_len) {
...
static void __hpat_timsort_mergeright_run(int64_t *comp_arr, const int64_t run1_len, const int64_t run2_len, int64_t * temp_buffer,
                                          const int64_t stack_ptr, int64_t ** all_arrs, const size_t all_arrs_len ,const size_t min_len) {
  // array layout [ run 1 || run 2]
