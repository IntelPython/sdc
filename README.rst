...
More information about building and adding documentation can be found in ``README`` in the ``docs`` folder. `here <https://github.com/IntelPython/sdc/tree/master/docs/README.rst>`_.
